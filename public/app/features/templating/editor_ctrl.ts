...
export class VariableEditorCtrl {
  ...
  constructor($scope, datasourceSrv, variableSrv, templateSrv) {
    delete variableTypes['datasource'];
    delete variableTypes['adhoc'];
    delete variableTypes['constant'];
    delete variableTypes['interval'];
    ...
    $scope.edit = variable => {
      ...
      $scope.mode = 'edit';
      $scope.validate();
      $scope.current.datasource = 'Statseeker';
      datasourceSrv.get($scope.current.datasource).then(ds => {

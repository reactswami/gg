/** @deprecated Superseded by React SaveDashboardModal (dashboard/components/SaveDashboardModal/SaveDashboardModal.tsx) - directive still registered for HTML template compat */
...
export class SaveDashboardModalCtrl {
  ...
  save() {
    ...
    const _this = this;
    return this.dashboardSrv.save(saveModel, options).then(_this.postSave.bind(_this, options));
  }
